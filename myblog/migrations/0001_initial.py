# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2017-11-22 16:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='avatar/default.png', max_length=200, upload_to='avatar/%Y/%m', verbose_name='头像')),
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='myblog.Category', verbose_name='分类'),
        ),
    ]
